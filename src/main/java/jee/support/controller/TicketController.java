...
public class TicketController  {
    ...
    public String findTicket_by_money(Model model){
        PageInfo<Ticket> pageInfo=ticketService.findTicketList_by_type();
        model.addAttribute(pageInfo);
        return "listTicketPage";
    }
    @GetMapping(value = {"/type"})
    public String findTicket_by_type(Model model){
    ...
    public String pageTicketList(@RequestParam(value = "page", defaultValue = "1") int page,
        ...
        //默认每页记录
        String sizes =request.getParameter("views_page");

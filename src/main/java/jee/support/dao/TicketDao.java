...
public interface TicketDao {
    ...
    @Select("select * from ticket  order by money desc")

    public List<Ticket> findAllTickets_by_money();
    @Select("select * from ticket  order by type desc")

    public List<Ticket> findAllTickets_by_type();
